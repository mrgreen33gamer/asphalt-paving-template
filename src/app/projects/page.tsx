...
export default function ProjectsPage() {
  return (
    <main className={styles.pageWrapper}>
      <SectionIntro
        title="Our Projects"
        subtitle="Asphalt paving, sealcoating, parking lots, striping, pothole repair, and overlays across Central Texas — see what's possible for your property"
      />
      ...
      <div className={styles.section}>
        <ProjectCardGrid
          ...
          subtitle="Asphalt paving, sealcoating, parking lots, striping, repairs, and overlays across Central Texas — click any card for the full story"
        />
      </div>
