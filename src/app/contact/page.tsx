...
// Blackline Paving — Contact Page (unique build, not just a form import)
...
// ── Service options ────────────────────────────────────────────────────────────
const SERVICES = [
  'Asphalt Paving', 'Sealcoating', 'Parking Lots',
  'Line Striping', 'Pothole Repair', 'Overlay & Resurfacing',
  'Other / Not Sure',
];
...
const faq = [
  {
    ...
    answer: "Call us directly at (254) 880-8080 or fill out the form below. We respond to most requests within one business day and can usually schedule an on-site measure within the week.",
  },
  {
  ...
  },
  {
    ...
    answer: 'No — on-site estimates are always free, with no obligation to book. We measure, check grade and access, and leave you with a firm written price.',
  },
  {
    question: 'Do you handle overlay & resurfacing projects?',
  ...
  },
  {
    ...
    answer: "Our installer will tell you honestly after the assessment. If repair or refinish will restore the asphalt, we recommend that first — full replacement only when it makes sense. We'll always show you the numbers and let you decide.",
  },
];
  ...
  return (
    <main className={styles.page}>
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroInner}>
          ...
          <motion.h1 className={styles.heroTitle}
            ...
            Let&apos;s Get Your<br />
            <span className={styles.heroAccent}>Asphalt Done Right</span>
          </motion.h1>
        ...
        <div className={styles.mainInner}>
          ...
          <div className={styles.leftCol}>
            ...
            <div className={styles.infoCards}>
              {[
                ...
                },
                {
                  ...
                  label:     'Email',
                  value:     'hello@blacklinepaving.com',
                  href:      'mailto:hello@blacklinepaving.com',
                ...
                },
                {
                  ...
                  label:     'Address',
                  value:     '4200 Franklin Ave, Waco TX 76710',
            ...
            <div className={styles.trustBlock}>
              <p className={styles.trustHeading}>Why homeowners choose Blackline</p>
              {[
                'Flat-rate pricing — written quote before we start',
                '2-Year Workmanship on New Pavement on every install',
                'crew-paved, licensed contractors only',
              ...
              {submitted ? (
                <motion.div key="success" className={styles.successCard}
                  ...
                  <p className={styles.successText}>
                    A Blackline specialist will reach out shortly — usually within one business day. For urgent needs, call us at{' '}
                    <a href="tel:+12548808080">(254) 880-8080</a>.
                  </p>
                ...
                <motion.div key="form" className={styles.formCard}
                  ...
                  <div className={styles.formCardHeader}>
                    ...
                    <div>
                      <h2 className={styles.formTitle}>Request a Free On-Site Estimate</h2>
                    ...
                    <div className={styles.row}>
                      ...
                      <div className={styles.field}>
                        ...
                        <input id="c-phone" className={styles.input} name="phone" type="tel"
                          placeholder="(254) 880-8080" required value={formData.phone} onChange={handleChange} />
                      </div>
                    </div>
      ...
      <CTABanner
        ...
        subline="Call (254) 880-8080 — free on-site estimates, flat-rate pricing, 2-Year Workmanship on New Pavement."
