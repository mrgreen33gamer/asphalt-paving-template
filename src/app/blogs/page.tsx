    ...
    <main className={styles.page}>
      ...
      <section className={styles.pageHeader}>
        ...
        >
          ...
          <h1 className={styles.pageTitle}>Blackline Paving &amp; Flatwork — Blog</h1>
          <p className={styles.pageSubtitle}>
            Real talk and useful tips for Central Texas homeowners — custom vs semi-asphalt pavings, materials for Central Texas, and when to reface or replace.
          </p>
        </motion.div>
      </section>
        ...
        <div className={styles.container}>
          ...
          >
            <p className={styles.blogCTAHeading}>
              Need asphalt paving in Central Texas?
            </p>
            <p className={styles.blogCTABody}>
              We&apos;ve been building asphalt pavings for Waco-area homes and businesses since 2003. Free in-home estimate, no obligations.
            </p>
