...
const LocalCitationBlock: React.FC<LocalCitationBlockProps> = ({
  businessName  = 'Blackline Paving',
  address       = '4200 Franklin Ave, Waco, TX 76710',
  phone         = '(254) 880-8080',
  email         = 'hello@blacklinepaving.com',
  googleMapsUrl = 'https://maps.google.com/?q=Blackline+Asphalt paving+Waco+TX',
  hours         = DEFAULT_HOURS,
  cityName      = 'Waco',
}) => {
  return (
      ...
      <div className={styles.container}>
        ...
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>
            Based in {cityName}, TX — serving all of Central Texas with asphalt paving, sealcoating, and parking lots.
          </p>
        </div>
