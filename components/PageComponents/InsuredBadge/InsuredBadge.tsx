...
const COVERAGES = [
  ...
  {
    icon: faBriefcase,
    title: 'Commercial Paving Contractor',
    detail: 'Asphalt paving by local Waco crews',
  },
  {
    icon: faFileContract,
    ...
    return (
      <div className={styles.inlineBadge}>
        ...
        <span className={styles.inlineText}>
          Commercial Paving Contractor · Bonded & Insured · bonded & insured · Commercial Paving Contractor
        </span>
      </div>
    );
  }
        ...
        >
          ...
          <div className={styles.headerText}>
            ...
            <p className={styles.subtitle}>
              ...
              contractor, and our 2-Year Workmanship on New Pavement. You get peace of mind —
