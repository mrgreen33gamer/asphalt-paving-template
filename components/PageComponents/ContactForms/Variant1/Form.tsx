...
const SERVICES = [
  { icon: faRoad,            label: 'Asphalt Paving' },
  { icon: faPersonWalking,   label: 'Sealcoating' },
  { icon: faHouse,           label: 'Parking Lots' },
  { icon: faPaintRoller,     label: 'Line Striping' },
  { icon: faWrench,          label: 'Pothole Repair' },
  { icon: faIndustry,        label: 'Overlay & Resurfacing' },
...
const TRUST_CHIPS = [
  ...
  { icon: faShieldHalved, text: 'Bonded · Insured' },
            ...
            {submitted ? (
              <motion.div key="success" className={styles.successState}
                ...
                <p className={styles.successText}>
                  An Blackline estimator will reach out shortly. Keep an eye on your inbox and phone.
                </p>
                ...
                <form className={styles.form} onSubmit={handleSubmit} noValidate>
                  ...
                  <div className={styles.submitRow}>
                    ...
                    <div className={styles.altContact}>
                      ...
                      <span>Need help now?{' '}
                        <a href="tel:+12548808080"
                          onClick={() => trackEvent({ eventType: 'phone_click', elementLabel: 'Call (254) 880-8080', section: 'ContactForm-V1' })}>
                          Call (254) 880-8080
                        </a>
                      </span>
                    </div>
