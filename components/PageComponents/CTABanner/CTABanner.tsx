...
export default function CTABanner({
  ...
  spot = "CTABanner",
  imageSrc,
  eyebrow = "Blackline · Central Texas",
  badgeA = "Free Measure",
  badgeB = "Commercial OK",
  badgeC = "Warrantied",
}: CTABannerProps) {
  ...
  return (
    <section className={styles.banner} aria-label="Call to action">
      ...
      <motion.div
        ...
        animate={{ x: [0, 8, 0], opacity: [0.5, 0.85, 0.5] }}
        transition={{ duration: 4, repeat: Infinity, ease: 'easeInOut' }}
        aria-hidden="true"
      >
        <svg width="420" height="420" viewBox="0 0 24 24" fill="currentColor"><path d="M18 4l-2 16h-2.5l.7-5.5H10.8L11.5 20H9L7 4h2.5l.6 5h4.8l.6-5H18zM10.3 11.5h3.4l.3-2.5h-4l.3 2.5z" opacity="0.8"/></svg>
      </motion.div>
