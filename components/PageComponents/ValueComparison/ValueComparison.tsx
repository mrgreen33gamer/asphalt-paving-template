...
const DEFAULT_ROWS: ComparisonRow[] = [
  { feature: 'Flat-rate quote before pave day',     us: true,  others: false },
  { feature: '5-Year workmanship warranty',            us: true,  others: false },
  { feature: 'Crew-paved commercial asphalt',            us: true,  others: 'Sometimes' },
  ...
  { feature: 'Free on-site estimate',               us: true,  others: false },
  { feature: 'Residential & overlay & resurfacing',      us: true,  others: 'Sometimes' },
...
export default function ValueComparison({ rows = DEFAULT_ROWS, title = 'Blackline vs. The Other Guys' }: ValueComparisonProps) {
  return (
