...
const personSchema = {
  ...
  "@type": "Person",
  name: "Vince Alvarez",
  jobTitle: "Founder & Lead Paving Contractor",
  worksFor: {
    "@type": "Organization",
  ...
  description:
    "Owner of Blackline Paving in Waco, TX. 23+ years paving driveways, parking lots, and commercial asphalt for Central Texas homes and businesses.",
};

const AuthorBio: React.FC<AuthorBioProps> = ({
  cityName,
  imageSrc = "/pages/seo-template-resources/owner.jpg",
  imageAlt = "Vince Alvarez - Founder of Blackline Paving",
}) => {
    ...
    <section className={styles.authorBio} aria-label="About the Author">
      ...
      <div className={styles.card}>
        ...
        <div className={styles.content}>
          <p className={styles.role}>Owner & Lead Paving Contractor · Blackline Paving</p>
          <h2 className={styles.title}>Vince Alvarez</h2>
          ...
          <div className={styles.footer}>
            ...
            <a
              ...
              aria-label="Connect with Vince Alvarez on LinkedIn"
              onClick={() => trackEvent({
                eventType:    'click',
