...
const SERVICE_CTAS = [
  {
    ...
    headline: 'Ready for asphalt done right?',
    body: 'New and replacement asphalt — flat-rate quote before we pave.',
  ...
  },
  {
    ...
    icon: faBath,
    eyebrow: 'Sealcoating',
    headline: 'Need sealcoat before summer UV?',
    body: 'Protective sealcoat that restores color and blocks UV.',
    cta: 'Get a Sealcoat Quote',
  ...
  },
  {
    ...
    eyebrow: 'Pothole Repair',
    headline: 'Need a pothole patched right?',
    body: 'Honest patch-vs-overlay advice and durable cut-and-patch work.',
    cta: 'Explore Repairs',
  ...
  },
  {
    key: 'overlay',
    icon: faBuilding,
    eyebrow: 'Overlay & Resurfacing',
    headline: 'Planning a mill and overlay?',
    body: 'Restore ride quality when the base is sound — faster than full rebuild.',
    cta: 'Talk to Our Team',
    href: '/services/overlay-resurfacing',
    accent: 'obsidian' as const,
  },
];
