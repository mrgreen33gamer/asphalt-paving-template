...
export default function NearbyAreasHero({
  ...
  const displayHeadline = headline ?? `Asphalt Paving in ${cityName}, TX`;
  const displayDesc     = description ??
    `Blackline Paving provides fast, reliable heating and cooling service to ${cityName} and all surrounding communities. Licensed technicians, flat-rate pricing, 1-year warranty on every job.`;
    ...
    <section className={styles.section}>
      ...
      <div className={styles.container}>
        ...
        >
          ...
          <a href="tel:+12548808080" className={styles.phoneBtn}>
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
