...
const DEFAULT_GUARANTEES: Guarantee[] = [
  ...
  {
    icon: faShieldHalved,
    title: "2-Year Workmanship on New Pavement",
    description:
      "New pavement work is covered for two full years on workmanship. If our work fails within that window, we fix it at no charge.",
  },
  {
    icon: faRotateLeft,
    title: "Satisfaction Guarantee",
    description:
      "Not satisfied with our work? We'll return to make it right. We stand behind every pave, no exceptions.",
  },
  {
    icon: faCertificate,
    title: "Commercial Paving Contractor · Bonded & Insured",
    description:
      "Every project is led by a commercial paving contractor with full insurance. No fly-by-night crews.",
  },
  {
    icon: faCalendarCheck,
    title: "Clear Lead Times",
    description:
      "We give honest prep and pave timelines with your quote — not vague windows that slip week after week.",
  },
  {
    icon: faStar,
    title: "On-Time or We Call Ahead",
    description:
      "We respect your time. If we're running late for a estimate or pave, we call before your window closes.",
  },
];

const GuaranteeSection: React.FC<GuaranteeSectionProps> = ({
  title      = "Our Promise to You",
  headline   = "We back every pave\nwith real guarantees.",
      ...
      <div className={styles.container}>
        ...
        <div className={styles.leftCol}>
          ...
          <p className={styles.body}>
            Every asphalt paving contractor in Central Texas makes promises. We back ours in writing — with flat-rate quotes, crew-paveed quality, and a 2-Year Workmanship on New Pavement on every pave.
          </p>
          <Link
            href={ctaLink}
