...
const INDUSTRIES = [
  { slug: 'retail centers-developers', label: 'Retail Centers', icon: faHardHat },
  { slug: 'interior-designers',      label: 'Schools & Municipal',        icon: faDraftingCompass },
  { slug: 'commercial-hospitality',  label: 'Industrial Yards',  icon: faHotel },
];
...
export default function SectionIndustriesServed({
  ...
  subtitle = 'Asphalt paving programs built for how your organization actually works.',
  disableLinks = false,
