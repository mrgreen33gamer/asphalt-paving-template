...
const logoName = 'Blackline Paving';
const logoTagline = 'Asphalt Paving · Sealcoating · Striping';
const navLinks = [
  { href: '/', label: 'Home' },
...
const phoneDisplay = '(254) 880-8080';
const phoneHref = 'tel:+12548808080';
...
const footerLine = 'Commercial Paving Contractor · Bonded & Insured · Waco, TX';
